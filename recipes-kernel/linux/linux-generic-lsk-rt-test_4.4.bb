...
DESCRIPTION = "Generic 4.4 LSK RT test kernel"

PV = "4.4+git${SRCPV}"
SRCREV_kernel = "fc3724be5ce94035d00f4e7dc9515e4a2047bc75"
SRCREV_FORMAT = "kernel"

SRC_URI = "\
    git://git.linaro.org/kernel/linux-linaro-stable.git;protocol=https;branch=linux-linaro-lsk-v4.4-rt-test;name=kernel \
