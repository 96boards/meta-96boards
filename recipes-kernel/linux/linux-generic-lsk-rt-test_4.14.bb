...
DESCRIPTION = "Generic 4.14 LSK RT test kernel"
...
SRC_URI = "\
    git://git.linaro.org/kernel/linux-linaro-stable.git;protocol=https;branch=linux-linaro-lsk-v4.14-rt-test;name=kernel \
